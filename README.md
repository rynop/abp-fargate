...
1. Create an ECR [image repository](https://console.aws.amazon.com/ecs/home?region=us-east-1#/repositories).  Naming convention `<app>/<branch>`.  `<app>` is not your github repo name, it is something generic you come up with.  The idea is this ECR repo can contin images for many github repo codebases.
